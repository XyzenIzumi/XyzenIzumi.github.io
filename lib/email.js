    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api KiiOfc - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
            ...
            <span style="display: block;"><br>Regards,<br>KiiOfc</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"KiiOfc" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api KiiOfc`,
        html: inboxGmail,
      };
